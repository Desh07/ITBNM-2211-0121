...
public class BillDao {
    ...
    public static ArrayList<Bill> getAllRecordsByAscending(String date){
        ArrayList<Bill> arrayList = new ArrayList<>();
        try{
            ResultSet rs = dbo.getData("select *from bill where date like '%"+date+"%'");
            while(rs.next()){
            Bill bill = new Bill();
        ...
        ArrayList<Bill> arrayList = new ArrayList<>();
        try{
            ResultSet rs = dbo.getData("select *from bill where date like '%"+date+"%' order By id Descending");
            while(rs.next()){
            Bill bill = new Bill();
            bill.setId(rs.getInt("id"));
            bill.setName(rs.getString("name"));
